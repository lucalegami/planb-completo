...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7538)), "C:\\Users\\ester\\Desktop\\planb-completo\\app\\delphic-signals\\page.js"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 668)), "C:\\Users\\ester\\Desktop\\planb-completo\\app\\layout.js"],
          
        }
      ]
      }.children;
    const pages = ["C:\\Users\\ester\\Desktop\\planb-completo\\app\\delphic-signals\\page.js"];
    ...
    const originalPathname = "/delphic-signals/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3968))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DelphicSignals)
/* harmony export */ });
...
const mockPrices = {
    AAPL: Array.from({
        length: 100
    }, (_, i)=>160 + i * 0.3 + Math.random()),
    MSFT: Array.from({
        length: 100
    }, (_, i)=>290 + i * 0.25 + Math.random()),
    TSLA: Array.from({
        length: 100
    }, (_, i)=>200 + i * 0.5 - Math.random()),
    AMZN: Array.from({
        length: 100
    }, (_, i)=>120 + i * 0.35 + Math.random()),
    GOOGL: Array.from({
        length: 100
    }, (_, i)=>105 + i * 0.3 + Math.random()),
    META: Array.from({
        length: 100
    }, (_, i)=>150 + i * 0.4 + Math.random()),
    NVDA: Array.from({
        length: 100
    }, (_, i)=>250 + i * 0.6 + Math.random()),
    JPM: Array.from({
        length: 100
    }, (_, i)=>130 + i * 0.2 + Math.random()),
    UNH: Array.from({
        length: 100
    }, (_, i)=>500 + i * 0.1 + Math.random()),
    XOM: Array.from({
        length: 100
    }, (_, i)=>100 + i * 0.15 + Math.random())
};
const sma = (arr, period, endIndex)=>arr.slice(endIndex - period + 1, endIndex + 1).reduce((a, b)=>a + b, 0) / period;
...
function DelphicSignals() {
    const [signals, setSignals] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                ...
                children: "\uD83D\uDCD0 Segnali Delphic – S&P 500 (Top 10)"
            }),
            signals.length === 0 ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                children: "Nessun segnale attivo."
                ...
                children: signals.map((s, i)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        style: {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\ester\Desktop\planb-completo\app\delphic-signals\page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [95,447], () => (__webpack_exec__(2830)));
